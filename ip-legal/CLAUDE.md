...
| Legal research (CourtListener) | [PLACEHOLDER ✓/✗] | Manual research — the skill will tell you which cases to pull |
...
- `[Westlaw]` / `[CourtListener]` / `[USPTO]` / `[Trellis]` — ONLY if the citation appears in a tool result from that MCP in this conversation.
